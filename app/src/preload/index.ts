...
const api: PamOscApi = {
  ...
  installMa3Plugin: (pluginsDir, overwrite) => ipcRenderer.invoke(IPC.installMa3Plugin, pluginsDir, overwrite),
  revealBundledPlugin: () => ipcRenderer.invoke(IPC.revealBundledPlugin),
