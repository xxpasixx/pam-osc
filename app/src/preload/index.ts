...
const api: PamOscApi = {
  ...
  deleteMapping: (id) => ipcRenderer.invoke(IPC.deleteMapping, id),
  deleteDevice: (id) => ipcRenderer.invoke(IPC.deleteDevice, id),
  ...
  getDeviceImage: (id) => ipcRenderer.invoke(IPC.getDeviceImage, id),
  ...
  listRemovableDrives: () => ipcRenderer.invoke(IPC.listRemovableDrives),
  chooseUsbFolder: () => ipcRenderer.invoke(IPC.chooseUsbFolder),
  copyPluginToUsb: (driveId, overwrite) => ipcRenderer.invoke(IPC.copyPluginToUsb, driveId, overwrite),
