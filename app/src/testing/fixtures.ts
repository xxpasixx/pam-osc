...
const testDevice = {
  ...
  controls: [
    { id: "fader-cc", type: "fader", midi: { kind: "cc", number: 7 }, position: { x: 0, y: 0, width: 1, height: 4 }, capabilities: { motorized: true } },
    { id: "fader-p", type: "fader", midi: { kind: "pitchbend", channel: 9 }, position: { x: 1, y: 0, width: 1, height: 4 }, capabilities: { motorized: true } },
    { id: "enc", type: "encoder", midi: { kind: "cc", number: 16 }, position: { x: 2, y: 0, width: 1, height: 1 }, capabilities: { encoding: { increment: { from: 1, to: 8 }, decrement: { from: 65, to: 72 } }, ledRing: { controller: 48, from: 32, to: 43 } } },
    { id: "enc-knob", type: "encoder", midi: { kind: "cc", number: 17 }, position: { x: 3, y: 0, width: 1, height: 1 }, capabilities: { encoding: { increment: { from: 1, to: 8 }, decrement: { from: 65, to: 72 } } } },
    { id: "enc-attr", type: "encoder", midi: { kind: "cc", number: 18 }, position: { x: 4, y: 0, width: 1, height: 1 }, capabilities: { encoding: { increment: { from: 1, to: 8 }, decrement: { from: 65, to: 72 } } } },
    { id: "btn-exec", type: "button", midi: { kind: "note", number: 10 }, position: { x: 0, y: 5, width: 1, height: 1 }, capabilities: { led: "on-off" } },
    { id: "btn-pad", type: "button", midi: { kind: "note", number: 12 }, position: { x: 1, y: 5, width: 1, height: 1 }, capabilities: { led: "none" } },
    { id: "btn-cmd", type: "button", midi: { kind: "note", number: 20 }, position: { x: 2, y: 5, width: 1, height: 1 }, capabilities: { led: "on-off" } },
    { id: "btn-qk", type: "button", midi: { kind: "note", number: 21 }, position: { x: 3, y: 5, width: 1, height: 1 }, capabilities: { led: "none" } },
    { id: "btn-fine", type: "button", midi: { kind: "note", number: 22 }, position: { x: 4, y: 5, width: 1, height: 1 }, capabilities: { led: "on-off" } },
    { id: "btn-rough", type: "button", midi: { kind: "note", number: 23 }, position: { x: 5, y: 5, width: 1, height: 1 }, capabilities: { led: "on-off" } },
    { id: "btn-attr-dim", type: "button", midi: { kind: "note", number: 24 }, position: { x: 6, y: 5, width: 1, height: 1 }, capabilities: { led: "on-off" } },
    { id: "btn-attr-pan", type: "button", midi: { kind: "note", number: 25 }, position: { x: 7, y: 5, width: 1, height: 1 }, capabilities: { led: "on-off" } },
    { id: "btn-tc-sel", type: "button", midi: { kind: "note", number: 26 }, position: { x: 0, y: 6, width: 1, height: 1 }, capabilities: { led: "none" } },
    { id: "btn-tc-pp", type: "button", midi: { kind: "note", number: 27 }, position: { x: 1, y: 6, width: 1, height: 1 }, capabilities: { led: "none" } },
    { id: "btn-always", type: "button", midi: { kind: "note", number: 28 }, position: { x: 2, y: 6, width: 1, height: 1 }, capabilities: { led: "on-off" } },
    { id: "display-1", type: "display", index: 0, position: { x: 0, y: 8, width: 1, height: 1 }, capabilities: { segments: 7 } },
    { id: "display-2", type: "display", index: 1, position: { x: 1, y: 8, width: 1, height: 1 }, capabilities: { segments: 7 } },
  ],
};
...
const testMapping = {
  ...
  assignments: [
    ...
    { controlId: "btn-attr-dim", action: { type: "modifier", modifier: "attributeSelect", attribute: "dimmer" }, feedback: { type: "on-off" } },
    { controlId: "btn-attr-pan", action: { type: "modifier", modifier: "attributeSelect", attribute: "pan" }, feedback: { type: "on-off" } },
    { controlId: "btn-tc-sel", action: { type: "timecodeSelect" }, options: { minValue: 100 } },
    { controlId: "btn-tc-pp", action: { type: "timecodePlayPause" } },
    { controlId: "btn-always", action: { type: "command", command: "Go+" }, feedback: { type: "always-on", value: 64 } },
