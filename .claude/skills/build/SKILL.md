...
A feature that touches a domain with a vetted skill installed follows that skill, not memory. The domain skill governs _how_ to integrate; the spec governs _what_; the gates below still apply.
