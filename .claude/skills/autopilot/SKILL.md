...
**Only the user starts autopilot.** Never invoke it on your own (`disable-model-invocation` enforces this) — but when a request clearly fits ("this must be high quality, I have time"), _suggest and describe it_ and let the user run it.
