...
## Rollback
Fastest fix is re-releasing the last good version — know how *before* you need it (it's part of the Environments & Release record): re-promote the previous build, revert the merge commit, or restore the previous package. Then fix forward on a branch.
