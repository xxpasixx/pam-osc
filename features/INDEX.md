...
| PAM-14 | First-run setup wizard — linear onboarding from launch to a verified connection (move-a-fader success); reuses existing screens                                          | P1       | PAM-3, PAM-4, PAM-9 | In Review | [PAM-14](PAM-14-first-run-setup-wizard/)           | 2026-07-18 |
...
| PAM-16 | Config handshake — app tells the plugin which executors + feature flags to watch (from mapping + settings), with a periodic re-sync that self-heals a stuck plugin       | P1       | PAM-2, PAM-12, PAM-3 | Building | [PAM-16](PAM-16-config-handshake/)                 | 2026-07-18 |
