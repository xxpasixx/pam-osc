...
| PAM-10 | Colored button feedback — RGB pads reflect the live MA3 executor sequence colour (nearest palette entry, lit while running); device-declared LED palettes             | P2       | PAM-2, PAM-16       | Approved | [PAM-10](PAM-10-colored-button-feedback/)          | 2026-07-16 |
...
| PAM-14 | First-run setup wizard — linear onboarding from launch to a verified connection (move-a-fader success); reuses existing screens                                          | P1       | PAM-3, PAM-4, PAM-9 | Approved | [PAM-14](PAM-14-first-run-setup-wizard/)           | 2026-07-18 |
...
| PAM-16 | Config handshake — app tells the plugin which executors + feature flags to watch (from mapping + settings), with a periodic re-sync that self-heals a stuck plugin       | P1       | PAM-2, PAM-12, PAM-3 | Approved | [PAM-16](PAM-16-config-handshake/)                 | 2026-07-18 |
| PAM-17 | UX review follow-ups — notices over the editor (High), clipboard/retry recoverability, selectable text, modal/tab a11y, jargon &amp; copy cleanup, editor keyboard nav        | P1       | PAM-3, PAM-4, PAM-6 | Approved | [PAM-17](PAM-17-ux-review-followups/)              | 2026-07-18 |
...
| PAM-19 | Mapping status — draft / community / tested badge per mapping (self-declared), shown in lists &amp; pickers; supports community sharing                                    | P2       | PAM-1, PAM-11, PAM-7 | Approved | [PAM-19](PAM-19-mapping-status/)                   | 2026-07-19 |
| PAM-20 | Signed (two's-complement) relative encoder decoding — Akai scheme (APC40 Cue Level/Tempo); adds encoder `encoding.mode`; Cue Level → executor                          | P1       | PAM-1, PAM-2        | Approved | [PAM-20](PAM-20-relative-encoder-decoding/)        | 2026-07-19 |
| PAM-21 | Board images — user-supplied hardware photo per board (convention `images/&lt;id&gt;.png` + optional override), shown in Boards list &amp; picker; licence-clean, ships none  | P2       | PAM-1, PAM-6, PAM-11 | Approved | [PAM-21](PAM-21-board-images/)                     | 2026-07-19 |
| PAM-22 | Delete user boards &amp; mappings — remove local (non-bundled) files from the Boards list; bundled untouchable, board delete refused while referenced                       | P2       | PAM-6, PAM-11       | Approved | [PAM-22](PAM-22-delete-user-boards-mappings/)      | 2026-07-19 |
| PAM-23 | USB export of the MA3 plugin — list connected removable drives in a dropdown, one-click copy the bundled plugin + OSC config onto a stick in the `gma3_library/…` layout for console import | P2       | PAM-9, PAM-3        | Approved | [PAM-23](PAM-23-usb-plugin-export/)                | 2026-07-21 |
