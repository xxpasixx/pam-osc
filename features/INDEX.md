...
| PAM-3 | Setup & settings UI — console IP/ports, device selection, persisted locally | P0 | PAM-2 | Building | [PAM-3](PAM-3-setup-settings-ui/) | 2026-07-16 |
| PAM-4 | Status & diagnostics UI — connection check, plugin check, port diagnosis, MIDI test mode | P0 | PAM-2, PAM-3 | Spec'd | [PAM-4](PAM-4-status-diagnostics-ui/) | 2026-07-16 |
