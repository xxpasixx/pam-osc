...
| PAM-14 | First-run setup wizard — linear onboarding from launch to a verified connection (move-a-fader success); reuses existing screens                                          | P1       | PAM-3, PAM-4, PAM-9 | Building | [PAM-14](PAM-14-first-run-setup-wizard/)           | 2026-07-18 |
...
| PAM-17 | UX review follow-ups — notices over the editor (High), clipboard/retry recoverability, selectable text, modal/tab a11y, jargon &amp; copy cleanup, editor keyboard nav        | P1       | PAM-3, PAM-4, PAM-6 | Building | [PAM-17](PAM-17-ux-review-followups/)              | 2026-07-18 |
