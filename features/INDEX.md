...
|----|---------|----------|------------|--------|------|---------|
| PAM-1 | Device & mapping file format — devices (controls, MIDI notes, 2D positions) separated from mappings (control → MA3 action); bundled definitions for v1-supported boards | P0 | — | Spec'd | [PAM-1](PAM-1-device-mapping-file-format/) | 2026-07-16 |
